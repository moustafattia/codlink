    ...
    Column(
        ...
        approval.command?.let { cmd ->
            Text(
                ...
                modifier = Modifier
                    .fillMaxWidth()
                    .background(CodlinkTheme.codeBackground, RoundedCornerShape(6.dp))
                    .padding(8.dp),
            )
        }
                ...
                Row(horizontalArrangement = Arrangement.spacedBy(6.dp)) {
                    for (option in question.options) {
                        ...
                        Button(
                            ...
                            colors = ButtonDefaults.buttonColors(
                                containerColor = if (isSelected) CodlinkTheme.accent else CodlinkTheme.codeBackground,
                                contentColor = if (isSelected) Color.Black else CodlinkTheme.textPrimary,
                            ),
                        ) {
