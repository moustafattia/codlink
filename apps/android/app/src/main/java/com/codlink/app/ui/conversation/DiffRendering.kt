...
internal fun SyntaxHighlightedDiffBlock(
    ...
    val palette = remember(
        CodlinkTheme.textBody.toArgb(),
        CodlinkTheme.textSecondary.toArgb(),
        CodlinkTheme.success.toArgb(),
        CodlinkTheme.danger.toArgb(),
        CodlinkTheme.accentStrong.toArgb(),
        CodlinkTheme.codeBackground.toArgb(),
        CodlinkTheme.surface.copy(alpha = 0.72f).toArgb(),
    ) {
        DiffSyntaxPalette(
            context = CodlinkTheme.textBody.toArgb(),
            metadata = CodlinkTheme.textSecondary.toArgb(),
            addition = CodlinkTheme.success.toArgb(),
            deletion = CodlinkTheme.danger.toArgb(),
            hunk = CodlinkTheme.accentStrong.toArgb(),
            contextBackground = CodlinkTheme.codeBackground.toArgb(),
            metadataBackground = CodlinkTheme.surface.copy(alpha = 0.72f).toArgb(),
            additionBackground = CodlinkTheme.success.copy(alpha = 0.12f).toArgb(),
            deletionBackground = CodlinkTheme.danger.copy(alpha = 0.12f).toArgb(),
            hunkBackground = CodlinkTheme.accentStrong.copy(alpha = 0.12f).toArgb(),
        )
    }
    ...
    AndroidView(
        ...
        update = { scrollView ->
            ...
            textView.setTextColor(CodlinkTheme.textBody.toArgb())
