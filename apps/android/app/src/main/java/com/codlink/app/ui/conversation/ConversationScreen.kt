...
import com.codlink.app.state.hasActiveTurn
import com.codlink.app.state.canResumeViaIpc
import com.codlink.app.state.isActiveStatus
import com.codlink.app.ui.BerkeleyMono
import com.codlink.app.ui.ChatWallpaperBackground
...
import com.codlink.app.ui.isNearListBottom
import com.codlink.app.ui.rememberStickyFollowTail
...
fun ConversationScreen(
    ...
    val warmMarkwon = remember(context) {
        try {
            val prism4j = io.noties.prism4j.Prism4j(com.codlink.app.ui.Prism4jGrammarLocator())
    ...
    val headerScrimColor = if (hasWallpaper) CodlinkTheme.surface.copy(alpha = 0.75f) else CodlinkTheme.surface
        ...
        Column(
            ...
            Box(modifier = Modifier.weight(1f)) {
                if (thread == null) {
                    ...
                    val fadeColor = if (hasWallpaper) Color.Transparent else CodlinkTheme.background
                                    ...
                                    Modifier.drawWithContent {
                                        ...
                                        drawRect(
                                            brush = Brush.verticalGradient(
                                                colors = listOf(CodlinkTheme.background, Color.Transparent),
                                                startY = 0f,
                                                endY = 48f,
                                            ),
                                        )
                        ...
                        items(
                            ...
                            if (isExpanded) {
                                ...
                                Column(verticalArrangement = Arrangement.spacedBy(2.dp)) {
                                    ...
                                    // Debug turn metrics
                                    if (com.codlink.app.state.DebugSettings.enabled && com.codlink.app.state.DebugSettings.showTurnMetrics) {
                                        ...
                                        Text(
                                            text = metricsText,
                                            color = CodlinkTheme.textMuted.copy(alpha = 0.6f),
                                            fontSize = 10.sp,
                                            fontFamily = com.codlink.app.ui.BerkeleyMono,
                ...
                Column(
                    ...
                    if (pinnedContext != null) {
                        Row(
                            modifier = Modifier
                                .fillMaxWidth()
                                .background(CodlinkTheme.codeBackground.copy(alpha = if (hasWallpaper) 0.75f else 1f))
                    ...
                    run {
                        ...
                        if (voiceLocalSession != null && voicePhase != null) {
                            com.codlink.app.ui.voice.InlineVoiceStatusStrip(
                                phase = voicePhase,
    ...
    Column(
        ...
        presets.forEach { preset ->
            Row(
                modifier = Modifier
                    .fillMaxWidth()
                    .background(CodlinkTheme.surface, RoundedCornerShape(16.dp))
...
private fun PlanContextBadge(progress: String) {
    Text(
        ...
        fontWeight = FontWeight.Medium,
        modifier = Modifier
            .background(CodlinkTheme.surface.copy(alpha = 0.72f), RoundedCornerShape(999.dp))
            ...
            item(key = "body-${section.id}") {
                if (section.title.isEmpty() || !collapsedSectionIds.contains(section.id)) {
                    SyntaxHighlightedDiffBlock(
                        ...
                        fontSize = CodlinkTextStyle.body.sp,
                        modifier = Modifier
                            .fillMaxWidth()
...
private fun StreamingCursor() {
    ...
    val shimmerBrush = Brush.linearGradient(
        colors = listOf(
            CodlinkTheme.textSecondary.copy(alpha = 0.4f),
            CodlinkTheme.accent,
            CodlinkTheme.textSecondary.copy(alpha = 0.4f),
        ),
