...
fun SubagentCard(
    ...
    Column(
        ...
        Row(
            ...
            Text(
                text = actionLabel,
                color = CodlinkTheme.toolCallCollaboration,
...
private fun statusColor(status: AppSubagentStatus?): Color {
    return when (status ?: AppSubagentStatus.UNKNOWN) {
        AppSubagentStatus.RUNNING -> CodlinkTheme.accent
        AppSubagentStatus.COMPLETED -> CodlinkTheme.success
        AppSubagentStatus.ERRORED -> CodlinkTheme.danger
