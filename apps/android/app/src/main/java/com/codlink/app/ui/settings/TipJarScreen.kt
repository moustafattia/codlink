...
private val TIP_PRODUCTS = listOf(
    TipProduct(
        productIds = listOf("tip_10", "com.codlink.litter.tip.10", "com.codlink.app.tip.10"),
        iconRes = com.codlink.app.R.drawable.tip_cat_10,
        displayName = "$9.99 Tip",
        fallbackPrice = "$9.99",
    ),
    TipProduct(
        productIds = listOf("tip_25", "com.codlink.litter.tip.25", "com.codlink.app.tip.25"),
        iconRes = com.codlink.app.R.drawable.tip_cat_25,
        displayName = "$24.99 Tip",
        fallbackPrice = "$24.99",
    ),
    TipProduct(
        productIds = listOf("tip_50", "com.codlink.litter.tip.50", "com.codlink.app.tip.50"),
        iconRes = com.codlink.app.R.drawable.tip_cat_50,
        displayName = "$49.99 Tip",
        fallbackPrice = "$49.99",
    ),
    TipProduct(
        productIds = listOf("tip_100", "com.codlink.litter.tip.100", "com.codlink.app.tip.100"),
        ...
        LazyColumn(verticalArrangement = Arrangement.spacedBy(4.dp)) {
            ...
            item {
                Column(
                    ...
                    Text(
                        "If you enjoy Codlink, consider leaving a tip. Tips help support ongoing development and are entirely optional.",
                ...
                is TipJarState.Ready -> {
                    ...
                    items(currentState.products) { tip ->
                        if (tip.isPurchased) {
                            ...
                            Row(
                                ...
                                Text(
                                    price,
                                    color = if (tip.details != null) CodlinkTheme.accent else CodlinkTheme.textSecondary,
                                    fontSize = 14.sp,
                                    fontWeight = FontWeight.SemiBold,
                                )
                            }
                    ...
                    item {
                        ...
                        TextButton(
                            ...
                            Text("Restore Purchases", color = CodlinkTheme.accent, fontSize = 14.sp)
                        }
                    }
