...
fun InlineVoiceStatusStrip(
    ...
    Row(
        modifier = modifier
            .fillMaxWidth()
            .background(CodlinkTheme.surface.copy(alpha = 0.6f))
        ...
        Row(
            ...
            Box(
                modifier = Modifier
                    .size(5.dp)
                    .background(
                        if (isListening) CodlinkTheme.accent else CodlinkTheme.textMuted.copy(alpha = 0.4f),
                        CircleShape,
                    ),
            )
            Text(
                text = "YOU",
                color = if (isListening) CodlinkTheme.textPrimary else CodlinkTheme.textMuted,
                fontSize = 10.sp,
        ...
        Row(
            ...
            Box(
                modifier = Modifier
                    .size(5.dp)
                    .background(
                        if (isSpeaking) CodlinkTheme.warning else CodlinkTheme.textMuted.copy(alpha = 0.4f),
                        CircleShape,
                    ),
            )
            Text(
                text = "CODEX",
                color = if (isSpeaking) CodlinkTheme.textPrimary else CodlinkTheme.textMuted,
                fontSize = 10.sp,
                fontWeight = FontWeight.Bold,
                fontFamily = CodlinkTheme.monoFont,
            )
